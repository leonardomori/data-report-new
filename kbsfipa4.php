...
<body>
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="">Kualitas</a>
			<ul class="sub1">
			 ...
			 <li><a href="tambahkbsfipa4.php">Tambah Data</a>
			</li>	 		 	
      </ul>
    </div>
  </nav>
	<h3>Kualitas Bak Sand Filter IPA 4</h3>
	...
	<table cellpadding="5" cellspacing="0" border="1">
		<tr bgcolor="#CCCCCC">
			...
			<th colspan="5" style="text-align: center;">Bak Sand Filter</th>
		</tr>
			<tr>
				<th>Turbidity (NTU)</th>
				<th>Ammo (mg/L)</th>
		...
		$query = mysql_query("SELECT * FROM kualitasbsf4 ORDER BY id_ipa ASC") or die(mysql_error());
