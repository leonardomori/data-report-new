...
<body>
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="">Debit Air Baku</a>
			<ul class="sub1">
			 ...
			 <li><a href="tambahipa1.php">Tambah Data</a>
			</li>	 		 	
      </ul>
    </div>
  </nav>
	<h3>Debit Produksi IPA 1</h3>
	...
	<table cellpadding="5" cellspacing="0" border="1">
		<tr bgcolor="#CCCCCC">
			...
			<th colspan="2" style="text-align: center;">IPA 1</th>
		</tr>
			<tr>
				<th>lps</th>
		...
		$query = mysql_query("SELECT * FROM ipa1 ORDER BY id_ipa ASC") or die(mysql_error());
