...
<body>
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="">Debit Distribusi</a>
			<ul class="sub1">
			 ...
			 <li><a href="tambahcsu.php">Tambah Data</a>
			</li>	 		 	
      </ul>
    </div>
  </nav>
	<h3>Debit Distribusi Cikarang Utara</h3>
	...
	<table cellpadding="5" cellspacing="0" border="1">
		<tr bgcolor="#CCCCCC">
			...
			<th colspan="2" style="text-align: center;">Cikarang Utara</th>
		</tr>
			<tr>
				<th>lps</th>
		...
		$query = mysql_query("SELECT * FROM csu ORDER BY id_ipa ASC") or die(mysql_error());
