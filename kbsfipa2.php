...
<body>
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="">Kualitas</a>
			<ul class="sub1">
			 ...
			 <li><a href="tambahkbsfipa2.php">Tambah Data</a>
			</li>	 		 	
      </ul>
    </div>
  </nav>
	<h3>Kualitas Bak Sand Filter IPA 2</h3>
	...
	<table cellpadding="5" cellspacing="0" border="1">
		...
		$query = mysql_query("SELECT * FROM kualitasbsf2 ORDER BY id_ipa ASC") or die(mysql_error());
