...
<body>
    ...
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="">Debit Air Baku</a>
			<ul class="sub1">
				<li><a href="ipa1.php">IPA 1</a></li>
				<li><a href="ipa2.php">IPA 2</a></li>
				<li><a href="ipa3.php">IPA 3</a></li>
				<li><a href="ipa4.php">IPA 4</a></li>
				<li><a href="ipa5.php">IPA 5</a></li>
				<li><a href="ipa6.php">IPA 6</a></li>
			</ul>
			</li>
			 <li><a href="tambahipa5.php">Tambah Data</a>
			</li>	 		 	
      </ul>
    </div>
  </nav>
	<h3>Debit Produksi IPA 5</h3>
	...
	<table cellpadding="5" cellspacing="0" border="1">
		<tr bgcolor="#CCCCCC">
			...
			<th colspan="2" style="text-align: center;">IPA 5</th>
		</tr>
			<tr>
				<th>lps</th>
				<th>Total Produk M <sup>3</sup></th>
			</tr>
		...
		$query = mysql_query("SELECT * FROM ipa5 ORDER BY id_ipa ASC") or die(mysql_error());
